...
class PathGenerator {
  ...
  public PathItem generate_singular(String schemaName, String schemaURI) {
    ...
    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_GET)) {
      path_item.get(new MapperOperation(schemaName, schemaURI, Method.GET, Cardinality.SINGULAR, this.configData.getAuth()).getOperation());
    }

    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_DELETE)) {
      path_item.delete(new MapperOperation(schemaName, schemaURI, Method.DELETE, Cardinality.SINGULAR, this.configData.getAuth()).getOperation());
    }

    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_POST)) {
      path_item.put(new MapperOperation(schemaName, schemaURI, Method.POST, Cardinality.SINGULAR, this.configData.getAuth()).getOperation());
    }

    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_PUT)) {
      path_item.put(new MapperOperation(schemaName, schemaURI, Method.PUT, Cardinality.SINGULAR, this.configData.getAuth()).getOperation());
    }
  ...
  public PathItem generate_plural(String schemaName, String schemaURI) {
    ...
    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_GET)) {
      path_item.get(new MapperOperation(schemaName, schemaURI, Method.GET, Cardinality.PLURAL, this.configData.getAuth()).getOperation());
    }

    if (this.configData.getConfigFlagValue(CONFIG_FLAG.PATH_POST)) {
      path_item.post(new MapperOperation(schemaName,schemaURI, Method.POST, Cardinality.PLURAL, this.configData.getAuth()).getOperation());
    }
